...
gulp.task('watch', function (done) {
  ...
  gulp.watch([paths.pages.html], {cwd: './'}, gulp.series('nun', function reload(done){reload(); done();}));
...
gulp.task('default', gulp.series('clean:dist', 'copy-assets', gulp.series('nun', 'sass', 'sass-min', 'bootstrapjs', 'mrarejs'), gulp.series('serve', 'watch')));

gulp.task('build', gulp.series('clean:dist', 'copy-assets', gulp.series('nun','sass', 'sass-min', 'bootstrapjs', 'mrarejs')));
